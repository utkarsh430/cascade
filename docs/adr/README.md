...
| [0043](0043-registry-placeholder-legs.md) | **Found here.** 15 of 180 sealed scenarios were exchange placeholder legs ("Candidate B"): the volume screen read a leg's zero as missing. Stand-ins excluded, leg volume and creation date honoured, domain read from the question. *Reseal awaits the owner* | M14 |
